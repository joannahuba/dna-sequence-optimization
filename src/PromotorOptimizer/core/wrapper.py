...
class SequencePredictorModelWrapper:
    ...
    def ReconstructSequences(
        ...
        for idx, (seq_id, seq_data) in enumerate(
            ...
            mutation_budget = seq_data[
                "mutation_budget"
            ]

            original_activity = seq_data[
                "original_activity"
            ]
            ...
            print(
                f"[INFO] Mutation budget = "
                f"{mutation_budget}"
            )

            print(
                f"[INFO] Target activity = "
                f"{original_activity}"
            )

            config = (
                reconstruction_config.copy()
            )

            config.update({
                "mutation_n": mutation_budget,
                "org_expression": original_activity,
