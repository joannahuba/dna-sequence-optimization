...
This document provides a formal mathematical description, biological justification, and computational examples of the deep learning model interpretation methods used within the SCAN (Stochastic Cooling Track Analysis) platform.
...
| **Reduction Strategy (`SCAN`)** | Absolute row sum | Absolute row sum | Row maximum |